...
class Trojkaty {
  ...
  /**
	...
	/** Glowna funkcja */
		...
		if(ileJednakowych(a, b, c) == 1) {
			System.out.println("Trojkat ma jedna pare boków tej samej dlugosci");
		}

		if(ileJednakowych(a, b, c) == 2) {
			System.out.println("Trojkat ma dwie pary boków o tej samej dlugosci");
		}
